...
global.allowJids = process.env.ALLOW_JID || "263732872101@s.whatsapp.net";
global.blockJids = process.env.BLOCK_JID || "null";
global.DATABASE_URL = process.env.DATABASE_URL || "";
global.timezone = process.env.TZ || process.env.TIME_ZONE || "Asia/Karachi";
global.github = process.env.GITHUB || "https://github.com/Pannelious/WASI-MD-V2";
global.gurl = process.env.GURL || "https://whatsapp.com/channel/0029Va8u2pmEquiUYlZh230t";
global.website = process.env.GURL || "https://whatsapp.com/channel/0029Va8u2pmEquiUYlZh230t";
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/49f8539eb637d8ea8731a.jpg";
global.devs = "923135673658";
global.sudo = process.env.SUDO || "263732872101";
global.owner = process.env.OWNER_NUMBER || "263732872101";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝐅𝐈𝐋𝐄-𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐄𝐃-𝐁𝐘-MASTERPEACE-𝐌𝐃-𝐕2😍",
  author: process.env.PACK_AUTHER || "MASTERPEACE",
  packname: process.env.PACK_NAME || "❣️",
  botname: process.env.BOT_NAME || "MASTERPEACE-𝐌𝐃-𝐕2",
  ownername: process.env.OWNER_NAME || "MASTERPEACE",
  errorChat: process.env.ERROR_CHAT || "263732872101",
